...
<form class="form-default" role="form" action="{{ route('addresses.update', $address_data->id) }}" method="POST">
    ...
    <div class="p-3">
		...
		<div id="pincode_div" class="row col-sm-12">
            <span id="pincode_msg" style="color:red;"><i class="las la-info-circle la-lg mb-3"></i></span>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3" placeholder="{{ translate('Your Postal Code')}}" value="{{ $address_data->postal_code }}" id="postal_code" name="postal_code" value="" required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-2">
...
<script>
	$('#postal_code').change(function() {
		...
		var url = 'addresses/check_pincode';
		...
		$.ajax({
			...
			success: function (res) {
				...
				//console.log(obj.msg);
				$('#pincode_div').css('display','block');
				$('#pincode_msg').text(obj.msg);
