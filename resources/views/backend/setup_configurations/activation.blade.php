...
<div class="row">
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/paypal.png') }}" height="30">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img   class="float-left" src="{{ url ('/assets/img/cards/stripe.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/sslcommerz.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
...
<div class="row">
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/instamojo.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/rozarpay.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/paystack.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
...
<div class="row">
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/vogue.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/payhere.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/ngenius.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/iyzico.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/bkash.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/nagad.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/proxypay.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/aamarpay.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/authorizenet.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/payku.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ url ('/assets/img/cards/cod.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
