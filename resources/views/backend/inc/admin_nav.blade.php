                ...
                <div class="align-items-stretch d-flex dropdown " id="lang-change">
                    <a class="dropdown-toggle no-arrow" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="btn btn-icon">
                            <img src="{{ url ('/assets/img/flags/'.$locale.'.png') }}" height="11">
                        </span>
                    </a>
                        ...
                        @foreach (\App\Models\Language::all() as $key => $language)
                            <li>
                                <a href="javascript:void(0)" data-flag="{{ $language->code }}" class="dropdown-item @if($locale == $language->code) active @endif">
                                    <img src="{{ url ('/assets/img/flags/'.$language->code.'.png') }}" class="mr-2">
                        ...
                        <span class="d-flex align-items-center">
                            <span class="avatar avatar-sm mr-md-2">
                                <img
                                    ...
                                    onerror="this.onerror=null;this.src='{{ url ('/assets/img/avatar-place.png') }}';"
                                >
                            </span>
